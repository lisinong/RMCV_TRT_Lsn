    ...
    public:
        ...
        struct CameraCalibrationStruct {
            ...
            CameraCalibrationStruct() { // 内参矩阵(缺省值)
                fx = 2018.16322055342f;
                fy = 2013.40273891104f;
                u0 = 626.795502676513f;
                v0 = 605.322783670577f;
                k_1 = 0.101755343148324f;
                k_2 = -0.828885008443791;
                p_1 = 0.00399885950790331f;
                p_2 = -0.0233028022306685f;
                k_3 = 0.0f;
            }
        };
